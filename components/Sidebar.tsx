...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, userRole, onLogout, isImpersonating, onExitImpersonation }) => {
  ...
  const tenantItems = [
    ...
    { id: 'proposals', label: 'Teklifler', icon: '📄', roles: [UserRole.ADMIN, UserRole.SALES, UserRole.PURCHASE, UserRole.SUPER_ADMIN] },
    { id: 'expenses', label: 'Masraflar', icon: '🧾', roles: [UserRole.ADMIN, UserRole.PURCHASE, UserRole.SALES, UserRole.SUPER_ADMIN] },
